...
import IndividualAchatsTableEdition from "./IndividualAchatsTable";
import AssociationAchatsTableEdition from "./AssociationAchatsTable";

export default function AchatsListTableEdition({
  isCultivatorsPage,
  individualData,
  associationData,
  datapagination,
