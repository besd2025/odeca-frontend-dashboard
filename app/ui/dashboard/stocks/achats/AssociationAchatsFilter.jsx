...
function AssociationAchatsFilter({ handleFilter }) {
  ...
  const [qteMinCA, setQTeMINCA] = React.useState("");
  const [qteMaxCA, setQTeMAXCA] = React.useState("");
  const [qteMinCB, setQTeMINCB] = React.useState("");
  const [qteMaxCB, setQTeMAXCB] = React.useState("");
  const [dateDebutEnregistre, setEnregistreDepuis] = React.useState("");
  const [dateFinEnregistre, setEnregistreJusquA] = React.useState("");
  ...
  const handleFilters = (e) => {
    ...
    const filterData = {
      ...
      qteMinCB: qteMinCB,
      qteMaxCB: qteMaxCB,
      dateDebutEnregistre: dateDebutEnregistre,
      dateFinEnregistre: dateFinEnregistre,
      dateAchatFrom: dateFrom,
      dateAchatTo: dateTo,
    };
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        value={qteMinCA}
                        onChange={(e) => setQTeMINCA(e.target.value)}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        value={qteMaxCA}
                        onChange={(e) => setQTeMAXCA(e.target.value)}
                        className="dark:bg-dark-900"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        placeholder="Entrer la quantité minimum"
                        value={qteMinCB}
                        onChange={(e) => setQTeMINCB(e.target.value)}
                        className="dark:bg-dark-900"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        placeholder="Entrer la quantité maximum"
                        value={qteMaxCB}
                        onChange={(e) => setQTeMAXCB(e.target.value)}
                        className="dark:bg-dark-900"
                      />
                    </div>
                  </div>
...
export default AssociationAchatsFilter;
