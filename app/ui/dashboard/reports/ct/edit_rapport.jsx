    ...
    React.useEffect(() => {
        const getCt = async () => {
            try {
                ...
                setSdlName(response?.sdl_ct?.sdl_ct?.ct?.ct_nom || "");
                setSoc(response?.sdl_ct?.sdl_ct?.ct?.sdl?.societe?.nom_societe || "");
    ...
    const handleSubmit = async (e) => {
        ...
        toast.promise(promise, {
            ...
            success: (data) => {
                ...
                return `le rapport du CT ${sdlName} a été modifié avec succès `;
            },
