...
export default function NoAffectedCts({ isLoading: externalLoading }) {
    ...
    React.useEffect(() => {
        const getSdls = async () => {
            setLoading(true);
            try {
                const response = await fetchData("get", "cafe/centres_transite/get_ct_non_responsable/", {
                    params: {
                        limit: limit,
                        offset: pointer,
                        ...filterData,
    ...
    const handleExportCTs = async () => {
        ...
        try {
            const initResponse = await fetchData("get", `cafe/centres_transite/get_ct_non_responsable/`, {
                params: { limit: 1 },
            });
